...
@param {string} word - The string to search for and replace.
...
export const findText = (
  element: { childNodes: string | any[] },
  pattern: { exec: (arg0: any) => any },
  callback: {
    call: (arg0: Window & typeof globalThis, arg1: any, arg2: any) => void
  }
) => {
